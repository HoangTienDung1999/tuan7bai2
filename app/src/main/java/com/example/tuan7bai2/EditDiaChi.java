...
public class EditDiaChi extends AppCompatActivity {
    TextView id;
    Button btnEdit;
    EditText editCity;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.editdiachi);
        ...
        btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ConnectDB.getInstance(EditDiaChi.this).diaChiDAO().updateDiachi(diaChiNew);
                Intent intent = new Intent(EditDiaChi.this,MainActivity.class);
